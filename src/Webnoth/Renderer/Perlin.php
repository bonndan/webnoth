 ...
 * @link https://gist.github.com/2173820
 */
...
class Perlin
{
     ...
     * @var int
     */
    private $_default_size = 64;
    
    /**
     * permutation
     * @var array(int)
     */
    private $permutation = array(151, 160, 137, 91, 90, 15,
     ...
     * @return type
     */
    protected function noise($x, $y, $z, $size = NULL)
    {
     ...
     * @return type
     */
    protected function smoothNoise($x, $y, $z)
    {
    ...
    protected function fade($t)
    {
        return $t * $t * $t * ( ( $t * ( ($t * 6) - 15) ) + 10);
    }

    protected function lerp($t, $a, $b)
    {
        //Make a weighted interpolaton between points
        return $a + $t * ($b - $a);
    }

    protected function grad($hash, $x, $y, $z)
    {
     ...
     * @param int $y
     */
    protected function random2D($x, $y)
    {
